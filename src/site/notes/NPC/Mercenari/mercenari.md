...
Le sprite rappresentano l'aspetto estetico del mercenario nelle sue varie rappresentazioni:
...
Ogni mercenario è definito da un set di otto statistiche che definiscono l'entità delle sue capacità.
