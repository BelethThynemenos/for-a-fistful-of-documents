...
determinano i possibili approcci che un mercenario può applicare per risolvere la missione e i tag che ogni missione possiede.

Ogni missione può avere da uno a tre approcci possibili.
I tipi di approcci sono direttamente legati alle [[statistiche\|statistiche]] dei [[mercenari\|mercenari]] e ai loro [[tratti\|tratti]] e vengono comparati con i tag, che definiscono i possibili contesti ed eventi che caratterizzano una missione.
[[Schede secondarie/Tabella dei tag di missione\|Tabella dei tag di missione]]
...
I possibili risultati per una missione scaduta e non completata dal giocatore sono:
- Fallita - in questo caso la missione risulta completata da 
- Completata da una gilda rivale
...
- una differente qualità del foglio di missione
	...
	Ogni categoria di richiedente di missione è definit
